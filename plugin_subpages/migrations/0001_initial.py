...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin_Subpages'
        db.create_table('plugin_subpages_plugin_subpages', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('title_rule', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('plugin_subpages', ['Plugin_Subpages'])


    def backwards(self, orm):
        # Deleting model 'Plugin_Subpages'
        db.delete_table('plugin_subpages_plugin_subpages')
