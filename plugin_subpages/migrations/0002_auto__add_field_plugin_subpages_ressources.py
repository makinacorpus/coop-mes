...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin_Subpages.ressources'
        db.add_column('plugin_subpages_plugin_subpages', 'ressources',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plugin_Subpages.ressources'
        db.delete_column('plugin_subpages_plugin_subpages', 'ressources')
    ...
    models = {
        ...
        'plugin_subpages.plugin_subpages': {
            'Meta': {'object_name': 'Plugin_Subpages'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ressources': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
