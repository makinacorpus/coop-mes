...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageApp_Account'
        db.create_table('page_account_pageapp_account', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('page_account', ['PageApp_Account'])


    def backwards(self, orm):
        # Deleting model 'PageApp_Account'
        db.delete_table('page_account_pageapp_account')
    ...
    models = {
        ...
        'page_account.pageapp_account': {
            'Meta': {'object_name': 'PageApp_Account'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'sites.site': {
