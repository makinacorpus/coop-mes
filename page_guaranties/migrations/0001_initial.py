...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageApp_Guaranties'
        db.create_table('page_guaranties_pageapp_guaranties', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('page_guaranties', ['PageApp_Guaranties'])


    def backwards(self, orm):
        # Deleting model 'PageApp_Guaranties'
        db.delete_table('page_guaranties_pageapp_guaranties')
    ...
    models = {
        ...
        'page_guaranties.pageapp_guaranties': {
            'Meta': {'object_name': 'PageApp_Guaranties'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'sites.site': {
