...
def initialize_django_env():
    ...
    with cd('/home/%(user)s/projects/%(projet)s' % env):
        ...
        with prefix('workon %(projet)s' % env):
            ...
            run('python ./manage.py loaddata coop_local/fixtures/{areatypes,django_site,exchange_methods,linkproperty,location_categories,top_roles,uriredirect,user,legalstatus,organizationcategory,organizationcategoryiae}.json')
