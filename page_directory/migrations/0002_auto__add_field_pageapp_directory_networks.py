...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageApp_Directory.networks'
        db.add_column('page_directory_pageapp_directory', 'networks',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageApp_Directory.networks'
        db.delete_column('page_directory_pageapp_directory', 'networks')
    ...
    models = {
        ...
        'page_directory.pageapp_directory': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'networks': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'sites.site': {
