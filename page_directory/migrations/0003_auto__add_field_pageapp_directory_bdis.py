...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageApp_Directory.bdis'
        db.add_column('page_directory_pageapp_directory', 'bdis',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageApp_Directory.bdis'
        db.delete_column('page_directory_pageapp_directory', 'bdis')
