...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageApp_Newsletter'
        db.create_table('page_newsletter_pageapp_newsletter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('page_newsletter', ['PageApp_Newsletter'])


    def backwards(self, orm):
        # Deleting model 'PageApp_Newsletter'
        db.delete_table('page_newsletter_pageapp_newsletter')
    ...
    models = {
        ...
        'page_newsletter.pageapp_newsletter': {
            'Meta': {'object_name': 'PageApp_Newsletter'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'sites.site': {
