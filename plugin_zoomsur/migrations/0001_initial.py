...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin_Zoomsur'
        db.create_table('plugin_zoomsur_plugin_zoomsur', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('title_rule', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('max_item', self.gf('django.db.models.fields.PositiveIntegerField')(default=6)),
        ))
        db.send_create_signal('plugin_zoomsur', ['Plugin_Zoomsur'])


    def backwards(self, orm):
        # Deleting model 'Plugin_Zoomsur'
        db.delete_table('plugin_zoomsur_plugin_zoomsur')
    ...
    models = {
        ...
        'plugin_zoomsur.plugin_zoomsur': {
            'Meta': {'object_name': 'Plugin_Zoomsur'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_item': ('django.db.models.fields.PositiveIntegerField', [], {'default': '6'}),
