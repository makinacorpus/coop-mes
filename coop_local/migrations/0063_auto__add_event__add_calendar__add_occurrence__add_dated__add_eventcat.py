...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('coop_local_event', (
            ...
            ('uuid', self.gf('django.db.models.fields.CharField')(default='6zWpboeCvsTw4Wy69pWfWk', max_length=50, null=True)),
            ...
            ('event_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_type', null=True, on_delete=models.PROTECT, to=orm['coop_local.EventCategory'])),
            ('calendar', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.Calendar'], on_delete=models.PROTECT)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'publisher organization', null=True, on_delete=models.PROTECT, to=orm['coop_local.Organization'])),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.Person'], null=True, on_delete=models.PROTECT, blank=True)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.Location'], null=True, on_delete=models.PROTECT, blank=True)),
        ...
        m2m_table_name = db.shorten_name('coop_local_event_category')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['coop_local.event'], null=False)),
        ...
        m2m_table_name = db.shorten_name('coop_local_event_organizations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['coop_local.event'], null=False)),
        ...
        db.create_table('coop_local_calendar', (
            ...
            ('uri_mode', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
            ('uri', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default='6hFB4jeZ8Fh33KbfwommC9', max_length=50, null=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('coop_local_event_category'))

        # Removing M2M table for field organizations on 'Event'
        db.delete_table(db.shorten_name('coop_local_event_organizations'))
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'uCTdTEoMu24keK8iNF5bzi'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.calendar': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'XyFAqMx3mxAvJFUrQjWVdk'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ifH2Qb2GNW6ML9TyzfpV9V'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.engagement': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'vfKiSqxdRmEMtEBej5eg7G'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.event': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'28CVFfgWVs7ExKmYV2FhQT'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.exchange': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'wtSjkryP8tGK44ytXekApm'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bgEJ45pXrZCnYxhhXSf7eB'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.organization': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'DB8uNqtFw3DvUeufG7E9Li'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'u3nii7nP4X2sTyP8STqRbZ'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.product': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'MyiNtYQStjp92tBjvdcAiQ'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.role': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'whj9ftPMFBV5RiND2URApc'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'9gWgbASnFaiwfSNruLfHTX'", 'max_length': '50', 'null': 'True'})
        },
