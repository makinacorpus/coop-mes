...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AgreementIAE'
        db.create_table('coop_local_agreementiae', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
        ))
        db.send_create_signal('coop_local', ['AgreementIAE'])

        # Deleting field 'Provider.agreement_iae'
        db.delete_column('coop_local_provider', 'agreement_iae')

        # Adding M2M table for field agreement_iae on 'Provider'
        db.create_table('coop_local_provider_agreement_iae', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('provider', models.ForeignKey(orm['coop_local.provider'], null=False)),
            ('agreementiae', models.ForeignKey(orm['coop_local.agreementiae'], null=False))
        ))
        db.create_unique('coop_local_provider_agreement_iae', ['provider_id', 'agreementiae_id'])


    def backwards(self, orm):
        # Deleting model 'AgreementIAE'
        db.delete_table('coop_local_agreementiae')

        # Adding field 'Provider.agreement_iae'
        db.add_column('coop_local_provider', 'agreement_iae',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Removing M2M table for field agreement_iae on 'Provider'
        db.delete_table('coop_local_provider_agreement_iae')
    ...
    models = {
        ...
        'coop_geo.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'zteYmvrADXgQKzC2ZgShrm'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_geo.arealink': {
        ...
        'coop_geo.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'yxJZ9ZsKH4fAW8mM7Shbq'", 'max_length': '50', 'unique': 'True', 'null': 'True'}),
        ...
        'coop_local.article': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'YznRA3LaJTjYYnTbphHxNB'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5Pkroushrf7VL6heYinR3g'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.document': {
        ...
        'coop_local.engagement': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'syQAZ77hAXsiPBCuxKJE8W'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.exchange': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'246y5Bo4W7AZD6URqfHsFS'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.navtree': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'oKmsJfvgMp57cVmpG3nxKB'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.network': {
        ...
        'coop_local.organization': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'oogYdwbWRR72kdD4uZqTcn'", 'max_length': '50', 'unique': 'True', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'WUks2W8NUQQMrW2ySDz6uY'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.product': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ubfTabDospXQs7QZLiWk4M'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.provider': {
        ...
        'coop_local.role': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6wtFHbWuJZ3zR6f2C9FALc'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3vYXiP5MVMcpHbeunaSZKo'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
