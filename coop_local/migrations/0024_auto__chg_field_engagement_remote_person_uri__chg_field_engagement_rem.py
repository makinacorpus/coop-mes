...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Engagement.remote_person_uri'
        db.alter_column('coop_local_engagement', 'remote_person_uri', self.gf('django.db.models.fields.URLField')(max_length=255, null=True))

        # Changing field 'Engagement.remote_role_label'
        db.alter_column('coop_local_engagement', 'remote_role_label', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Engagement.remote_organization_uri'
        db.alter_column('coop_local_engagement', 'remote_organization_uri', self.gf('django.db.models.fields.URLField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Engagement.remote_person_uri'
        db.alter_column('coop_local_engagement', 'remote_person_uri', self.gf('django.db.models.fields.URLField')(default='', max_length=255))

        # Changing field 'Engagement.remote_role_label'
        db.alter_column('coop_local_engagement', 'remote_role_label', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Engagement.remote_organization_uri'
        db.alter_column('coop_local_engagement', 'remote_organization_uri', self.gf('django.db.models.fields.URLField')(default='', max_length=255))
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7VZGrpt28LHtx6BVZJrGxV'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.article': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'HNvsNKfyQoGTnmFyuvFjpA'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'tFJcGCiFTAHG8VJ2nhj4gh'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.engagement': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2Qf2B7x3mCC9kpZV9AyweY'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.exchange': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'QWviT6ENwW2ysxFY5zwHV5'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a7x4QiXojv3RHXX32K4nLR'", 'max_length': '50', 'unique': 'True', 'null': 'True'}),
        ...
        'coop_local.navtree': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'D2pnbBP7u22eZcA4sqYq3R'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.network': {
        ...
        'coop_local.organization': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'XTyFmNtB2urx4Uf96bhftS'", 'max_length': '50', 'unique': 'True', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'gwPdquvuwtdWtLdmQ9dyaN'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.product': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'FDPtLjYV4VHQUMdtqEr7F7'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.provider': {
        ...
        'coop_local.role': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'WLGP7gqGZ3D2vJ3dMapJGf'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'WBPfKfhfRF8cgcETNNF42f'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
