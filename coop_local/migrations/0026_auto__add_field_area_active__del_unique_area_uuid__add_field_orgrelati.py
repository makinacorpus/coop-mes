...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Article', fields ['uuid']
        db.delete_unique('coop_local_article', ['uuid'])

        # Removing unique constraint on 'Organization', fields ['uuid']
        db.delete_unique('coop_local_organization', ['uuid'])

        # Removing unique constraint on 'NavTree', fields ['uuid']
        db.delete_unique('coop_local_navtree', ['uuid'])

        # Removing unique constraint on 'Tag', fields ['uuid']
        db.delete_unique('coop_local_tag', ['uuid'])

        # Removing unique constraint on 'Engagement', fields ['uuid']
        db.delete_unique('coop_local_engagement', ['uuid'])

        # Removing unique constraint on 'Contact', fields ['uuid']
        db.delete_unique('coop_local_contact', ['uuid'])

        # Removing unique constraint on 'Exchange', fields ['uuid']
        db.delete_unique('coop_local_exchange', ['uuid'])

        # Removing unique constraint on 'Person', fields ['uuid']
        db.delete_unique('coop_local_person', ['uuid'])

        # Removing unique constraint on 'Location', fields ['uuid']
        db.delete_unique('coop_local_location', ['uuid'])

        # Removing unique constraint on 'Product', fields ['uuid']
        db.delete_unique('coop_local_product', ['uuid'])

        # Removing unique constraint on 'Role', fields ['uuid']
        db.delete_unique('coop_local_role', ['uuid'])

        # Removing unique constraint on 'Area', fields ['uuid']
        db.delete_unique('coop_local_area', ['uuid'])

        # Adding field 'Area.active'
        db.add_column('coop_local_area', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'OrgRelationType.key_name'
        db.add_column('coop_local_orgrelationtype', 'key_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'OrgRelationType.org_to_org'
        db.add_column('coop_local_orgrelationtype', 'org_to_org',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'OrgRelationType.org_to_project'
        db.add_column('coop_local_orgrelationtype', 'org_to_project',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Role.active'
        db.add_column('coop_local_role', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Product.active'
        db.add_column('coop_local_product', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Location.active'
        db.add_column('coop_local_location', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Person.email_sha1'
        db.delete_column('coop_local_person', 'email_sha1')

        # Adding field 'Person.active'
        db.add_column('coop_local_person', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Person.pref_email'
        db.add_column('coop_local_person', 'pref_email',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='preferred_email', null=True, on_delete=models.SET_NULL, to=orm['coop_local.Contact']),
                      keep_default=False)

        # Adding field 'Exchange.active'
        db.add_column('coop_local_exchange', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Contact.active'
        db.add_column('coop_local_contact', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Engagement.active'
        db.add_column('coop_local_engagement', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Tag.active'
        db.add_column('coop_local_tag', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'NavTree.active'
        db.add_column('coop_local_navtree', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Article.active'
        db.add_column('coop_local_article', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('coop_local_area', 'active')

        # Adding unique constraint on 'Area', fields ['uuid']
        db.create_unique('coop_local_area', ['uuid'])

        # Deleting field 'OrgRelationType.key_name'
        db.delete_column('coop_local_orgrelationtype', 'key_name')

        # Deleting field 'OrgRelationType.org_to_org'
        db.delete_column('coop_local_orgrelationtype', 'org_to_org')

        # Deleting field 'OrgRelationType.org_to_project'
        db.delete_column('coop_local_orgrelationtype', 'org_to_project')

        # Deleting field 'Role.active'
        db.delete_column('coop_local_role', 'active')

        # Adding unique constraint on 'Role', fields ['uuid']
        db.create_unique('coop_local_role', ['uuid'])

        # Deleting field 'Product.active'
        db.delete_column('coop_local_product', 'active')

        # Adding unique constraint on 'Product', fields ['uuid']
        db.create_unique('coop_local_product', ['uuid'])

        # Deleting field 'Location.active'
        db.delete_column('coop_local_location', 'active')

        # Adding unique constraint on 'Location', fields ['uuid']
        db.create_unique('coop_local_location', ['uuid'])

        # Adding field 'Person.email_sha1'
        db.add_column('coop_local_person', 'email_sha1',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Person.active'
        db.delete_column('coop_local_person', 'active')

        # Deleting field 'Person.pref_email'
        db.delete_column('coop_local_person', 'pref_email_id')

        # Adding unique constraint on 'Person', fields ['uuid']
        db.create_unique('coop_local_person', ['uuid'])

        # Deleting field 'Exchange.active'
        db.delete_column('coop_local_exchange', 'active')

        # Adding unique constraint on 'Exchange', fields ['uuid']
        db.create_unique('coop_local_exchange', ['uuid'])

        # Deleting field 'Contact.active'
        db.delete_column('coop_local_contact', 'active')

        # Adding unique constraint on 'Contact', fields ['uuid']
        db.create_unique('coop_local_contact', ['uuid'])

        # Deleting field 'Engagement.active'
        db.delete_column('coop_local_engagement', 'active')

        # Adding unique constraint on 'Engagement', fields ['uuid']
        db.create_unique('coop_local_engagement', ['uuid'])

        # Deleting field 'Tag.active'
        db.delete_column('coop_local_tag', 'active')

        # Adding unique constraint on 'Tag', fields ['uuid']
        db.create_unique('coop_local_tag', ['uuid'])

        # Deleting field 'NavTree.active'
        db.delete_column('coop_local_navtree', 'active')

        # Adding unique constraint on 'NavTree', fields ['uuid']
        db.create_unique('coop_local_navtree', ['uuid'])

        # Adding unique constraint on 'Organization', fields ['uuid']
        db.create_unique('coop_local_organization', ['uuid'])

        # Deleting field 'Article.active'
        db.delete_column('coop_local_article', 'active')

        # Adding unique constraint on 'Article', fields ['uuid']
        db.create_unique('coop_local_article', ['uuid'])
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'9kk7UZrirKi5TWX6otFMNa'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.article': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5LpzoRZ84C3qL2Eff946ba'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'soA5UVAPiS3RbaFp8xnorU'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.engagement': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'QgfmKfRcUJGyuh5skCdvCm'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.exchange': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'YBxT7WqPQfe7mcMkKLquVU'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5s5ahUPDJEbHX7xGPm225F'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.navtree': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'93uwAMW7x3ZbQazTXDEoSY'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.network': {
        ...
        'coop_local.organization': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'gs6mrzPc7z9k3DyhdhCcCL'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'iYtu3AomsGPiq2riwJYayZ'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.product': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'iiukufGWgUUAB5XMnP7hpP'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.provider': {
        ...
        'coop_local.role': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4jAwBSZqwLSUD7L7BtnZFn'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'jB8bH8NdZVhhF78SP4jtjL'", 'max_length': '50', 'null': 'True'})
        },
