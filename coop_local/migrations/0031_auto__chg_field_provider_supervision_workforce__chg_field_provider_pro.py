...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Provider.supervision_workforce'
        db.alter_column('coop_local_provider', 'supervision_workforce', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=1))

        # Changing field 'Provider.production_workforce'
        db.alter_column('coop_local_provider', 'production_workforce', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=1))

        # Changing field 'Provider.workforce'
        db.alter_column('coop_local_provider', 'workforce', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=1))

        # Changing field 'Provider.annual_integration_number'
        db.alter_column('coop_local_provider', 'annual_integration_number', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=1))

        # Changing field 'Provider.integration_workforce'
        db.alter_column('coop_local_provider', 'integration_workforce', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=1))

    def backwards(self, orm):

        # Changing field 'Provider.supervision_workforce'
        db.alter_column('coop_local_provider', 'supervision_workforce', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Provider.production_workforce'
        db.alter_column('coop_local_provider', 'production_workforce', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Provider.workforce'
        db.alter_column('coop_local_provider', 'workforce', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Provider.annual_integration_number'
        db.alter_column('coop_local_provider', 'annual_integration_number', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Provider.integration_workforce'
        db.alter_column('coop_local_provider', 'integration_workforce', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'XK3W3razfJqaUQYZZhsiVS'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.article': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'yxrRNLZt6pJYREbUmjyMbh'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'NjJB4ftURp8QdUSHeu6JQP'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.engagement': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'9rNn6DpNB8wSkEceTsYvxH'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.exchange': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'Jfror9LdWc7fXR6MgMzKfa'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'VawBBQwpk5h8U8gtTeHL7H'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.navtree': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'uQKFUhT29KRAib5EapQASK'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.network': {
        ...
        'coop_local.organization': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ZuD8YWqYRzPesuDvfYnT2Q'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7dcSmTuaAMWdrJjazNggbj'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.product': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ykW6tWuasaYyXgYvAxZzDB'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.provider': {
        ...
        'coop_local.role': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'HrJ4E3gGVmUeRTbZhKeBRi'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'sGotQAiNSZC5yG8nGEQdFD'", 'max_length': '50', 'null': 'True'})
        },
