...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.location'
        db.alter_column('coop_local_contact', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.Location'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Organization.pref_email'
        db.alter_column('coop_local_organization', 'pref_email_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['coop_local.Contact']))

        # Changing field 'Organization.pref_phone'
        db.alter_column('coop_local_organization', 'pref_phone_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['coop_local.Contact']))

        # Changing field 'Organization.pref_address'
        db.alter_column('coop_local_organization', 'pref_address_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['coop_local.Location']))

    def backwards(self, orm):

        # Changing field 'Contact.location'
        db.alter_column('coop_local_contact', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.Location'], null=True))

        # Changing field 'Organization.pref_email'
        db.alter_column('coop_local_organization', 'pref_email_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['coop_local.Contact']))

        # Changing field 'Organization.pref_phone'
        db.alter_column('coop_local_organization', 'pref_phone_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['coop_local.Contact']))
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'dXBaqUEUJPmtPGZrH4SmVd'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.article': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'sooYfCQNNuvgFdRpSwdKVi'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'tTMpy3fr8e35miZuQshJFd'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.engagement': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'WoXz4NcfcPeKd9BsCcAgvh'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.exchange': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'qfwFZ4ktLPF257oEp9tUZn'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'nxd7o7VGdwY6DCdVhcAnGW'", 'max_length': '50', 'unique': 'True', 'null': 'True'}),
        ...
        'coop_local.navtree': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'Bs9Wf2BkgbogSkBHCwPm8a'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.network': {
        ...
        'coop_local.organization': {
            ...
            'pref_address': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'pref_adress'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['coop_local.Location']"}),
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'pw7Po8y848xic8YBUvvuyY'", 'max_length': '50', 'unique': 'True', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ymQa2MenED8GXaDVoVAKWQ'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.product': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'t8sNKpgkLCFtZFc9croR39'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.provider': {
        ...
        'coop_local.role': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'cyE8x79m4HsgytzbCFAmzd'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'uhSPvWVujXh8owLVbGQPe8'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
