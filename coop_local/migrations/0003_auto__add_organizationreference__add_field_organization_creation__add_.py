...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrganizationReference'
        db.create_table('coop_local_organizationreference', (
        ...
        db.send_create_signal('coop_local', ['OrganizationReference'])

        # Adding field 'Organization.creation'
        db.add_column('coop_local_organization', 'creation',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2012, 11, 19, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Organization.modification'
        db.add_column('coop_local_organization', 'modification',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2012, 11, 19, 0, 0), blank=True),
                      keep_default=False)
        ...
        # Adding field 'Organization.author'
        db.add_column('coop_local_organization', 'author',
    ...
    def backwards(self, orm):
        # Deleting model 'OrganizationReference'
        db.delete_table('coop_local_organizationreference')

        # Deleting field 'Organization.creation'
        db.delete_column('coop_local_organization', 'creation')

        # Deleting field 'Organization.modification'
        db.delete_column('coop_local_organization', 'modification')

        # Deleting field 'Organization.status'
        db.delete_column('coop_local_organization', 'status')

        # Deleting field 'Organization.correspondence'
        db.delete_column('coop_local_organization', 'correspondence')

        # Deleting field 'Organization.transmission'
        db.delete_column('coop_local_organization', 'transmission')

        # Deleting field 'Organization.author'
        db.delete_column('coop_local_organization', 'author')

        # Deleting field 'Organization.validation'
        db.delete_column('coop_local_organization', 'validation')
    ...
    models = {
        ...
        'coop_geo.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'kZYUoEXBFgm524QuVraHcA'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_geo.arealink': {
        ...
        'coop_geo.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'Y5m2icdanhzzPkxHoq66QX'", 'max_length': '50', 'unique': 'True', 'null': 'True'}),
        ...
        'coop_local.article': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'qBBfU8kVVg9A7sDsceLtpE'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'hJhbdDazkVcGCgj9dn8fPM'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.engagement': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'qKRWYxuAh9Jd7WbybhCmnH'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.exchange': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'RwnjTNiByHov3video6C3Y'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.navtree': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'uux3Hp88b8P9k3VkpR8wak'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.organization': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'uSfQv4dQz7DDjXwM7xGoYH'", 'max_length': '50', 'unique': 'True', 'null': 'True'}),
        ...
        'coop_local.organizationreference': {
            'Meta': {'object_name': 'OrganizationReference'},
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ytErhk3x5bjrWmRoEBiCJL'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.product': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'cXRsaE6Zy2xKH5ZnXrwxue'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.relation': {
        ...
        'coop_local.role': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'42LYmxCLFCqwWxqWN3WfJK'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'y89WbBX2uH7RVD7mxirafP'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
