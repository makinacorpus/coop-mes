...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CallForTenders'
        db.create_table('coop_local_callfortenders', (
            ...
            ('allotment', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('lot_numbers', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('deadline', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('clauses', self.gf('coop_local.models.fields.MultiSelectField')(max_length=200, blank=True)),
        ))
        db.send_create_signal('coop_local', ['CallForTenders'])

        # Adding M2M table for field activity on 'CallForTenders'
        db.create_table('coop_local_callfortenders_activity', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('callfortenders', models.ForeignKey(orm['coop_local.callfortenders'], null=False)),
            ('activitynomenclature', models.ForeignKey(orm['coop_local.activitynomenclature'], null=False))
        ))
        db.create_unique('coop_local_callfortenders_activity', ['callfortenders_id', 'activitynomenclature_id'])


    def backwards(self, orm):
        # Deleting model 'CallForTenders'
        db.delete_table('coop_local_callfortenders')

        # Removing M2M table for field activity on 'CallForTenders'
        db.delete_table('coop_local_callfortenders_activity')
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'M5SbtJYcJcAc8HpBBUcY5o'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'aHtCPS2wTFguTTxXrQq7f3'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.engagement': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b3iwdHoLMFkv8HtchcPqHC'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.exchange': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'agnmqJnmJqThqokKoVVUeg'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2DPDPJrwVFvWi2ixqRhTJR'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.organization': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'qMewPniJtSAjipPfRfoYyG'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'765in5inPVV4Zhcj3zAe5R'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.product': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'GibUXAqgBgccqiTYt3SDNe'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.role': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'s7rMtSNq7yhgs8WYotb6TU'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'VRAJTD8nTVYConG2ipgCGn'", 'max_length': '50', 'null': 'True'})
        },
