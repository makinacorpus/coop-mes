...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field sites on 'NavTree'
        db.delete_table('coop_local_navtree_sites')

        # Deleting model 'Article'
        db.delete_table('coop_local_article')

        # Removing M2M table for field sites on 'Article'
        db.delete_table('coop_local_article_sites')

        # Adding field 'Exchange.activity'
        db.add_column('coop_local_exchange', 'activity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.ActivityNomenclature'], null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field transverse_themes on 'Exchange'
        db.create_table('coop_local_exchange_transverse_themes', (
        ...
        db.create_unique('coop_local_exchange_transverse_themes', ['exchange_id', 'transversetheme_id'])

        # Adding field 'Organization.activity'
        db.add_column('coop_local_organization', 'activity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.ActivityNomenclature'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('coop_local_navtree', (
            ...
            ('uuid', self.gf('django.db.models.fields.CharField')(default='2puzeKoxKWaDGHbKfEFazW', max_length=50, null=True)),
        ...
        db.create_table('coop_local_article', (
            ...
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='coop_local_article_rel', null=True, to=orm['coop_cms.ArticleCategory'], blank=True)),
            ...
            ('slug', self.gf('django_extensions.db.fields.AutoSlugField')(populate_from='title', allow_duplicates=False, max_length=100, separator=u'-', blank=True, unique=True, overwrite=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default='JxzPnGtRTQVDFF2YyUc5D', max_length=50, null=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('summary', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='articles', null=True, to=orm['coop_local.Person'], blank=True)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(related_name='articles', null=True, to=orm['coop_local.Organization'], blank=True)),
        ))
        ...
        # Deleting field 'Exchange.activity'
        db.delete_column('coop_local_exchange', 'activity_id')

        # Removing M2M table for field transverse_themes on 'Exchange'
        db.delete_table('coop_local_exchange_transverse_themes')

        # Deleting field 'Organization.activity'
        db.delete_column('coop_local_organization', 'activity_id')
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'k6E7GSYWhn6cVrqZX6z96T'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'wx4nc7WujLw8nSSKSto6ze'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.engagement': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'mi3ju9nQwjy3fGHG2KgtiM'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.exchange': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'JzSvyhYNHVqUHbCEUZg2ZV'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'Zop7ymrSNBp6C3ieoVipuW'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.organization': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'zKjFhHPYqdXpbRFxHLNQeN'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'RLD4G7VBRhsuPNM3qxfJN9'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.product': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'TLMgLM2Yihgx3VxHZ74oaB'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.role': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'CbgvPZLj5DkQTjgNPVk4rj'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fSgjj36dmipCkCj8ky23QK'", 'max_length': '50', 'null': 'True'})
        },
