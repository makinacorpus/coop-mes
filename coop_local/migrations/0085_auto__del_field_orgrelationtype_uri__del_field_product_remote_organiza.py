...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OrgRelationType.uri'
        db.delete_column('coop_local_orgrelationtype', 'uri')

        # Deleting field 'Product.remote_organization_uri'
        db.delete_column('coop_local_product', 'remote_organization_uri')

        # Deleting field 'Product.remote_organization_label'
        db.delete_column('coop_local_product', 'remote_organization_label')

        # Deleting field 'RoleCategory.uri'
        db.delete_column('coop_local_rolecategory', 'uri')

        # Deleting field 'Exchange.remote_person_label'
        db.delete_column('coop_local_exchange', 'remote_person_label')

        # Deleting field 'Exchange.remote_organization_label'
        db.delete_column('coop_local_exchange', 'remote_organization_label')

        # Deleting field 'Exchange.remote_person_uri'
        db.delete_column('coop_local_exchange', 'remote_person_uri')

        # Deleting field 'Exchange.remote_organization_uri'
        db.delete_column('coop_local_exchange', 'remote_organization_uri')

        # Deleting field 'Event.remote_person_label'
        db.delete_column('coop_local_event', 'remote_person_label')

        # Deleting field 'Event.remote_organization_label'
        db.delete_column('coop_local_event', 'remote_organization_label')

        # Deleting field 'Event.remote_person_uri'
        db.delete_column('coop_local_event', 'remote_person_uri')

        # Deleting field 'Event.remote_location_uri'
        db.delete_column('coop_local_event', 'remote_location_uri')

        # Deleting field 'Event.remote_organization_uri'
        db.delete_column('coop_local_event', 'remote_organization_uri')

        # Deleting field 'Event.remote_location_label'
        db.delete_column('coop_local_event', 'remote_location_label')

        # Deleting field 'ExchangeMethod.uri'
        db.delete_column('coop_local_exchangemethod', 'uri')

        # Deleting field 'Engagement.remote_person_uri'
        db.delete_column('coop_local_engagement', 'remote_person_uri')

        # Deleting field 'Engagement.remote_person_label'
        db.delete_column('coop_local_engagement', 'remote_person_label')

        # Deleting field 'Engagement.remote_role_label'
        db.delete_column('coop_local_engagement', 'remote_role_label')

        # Deleting field 'Engagement.remote_organization_label'
        db.delete_column('coop_local_engagement', 'remote_organization_label')

        # Deleting field 'Engagement.remote_role_uri'
        db.delete_column('coop_local_engagement', 'remote_role_uri')

        # Deleting field 'Engagement.remote_organization_uri'
        db.delete_column('coop_local_engagement', 'remote_organization_uri')

        # Deleting field 'Tag.person_uri'
        db.delete_column('coop_local_tag', 'person_uri')

        # Deleting field 'Tag.concept_uri'
        db.delete_column('coop_local_tag', 'concept_uri')

        # Deleting field 'ContactMedium.uri'
        db.delete_column('coop_local_contactmedium', 'uri')


    def backwards(self, orm):
        # Adding field 'OrgRelationType.uri'
        db.add_column('coop_local_orgrelationtype', 'uri',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Product.remote_organization_uri'
        db.add_column('coop_local_product', 'remote_organization_uri',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Product.remote_organization_label'
        db.add_column('coop_local_product', 'remote_organization_label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'RoleCategory.uri'
        db.add_column('coop_local_rolecategory', 'uri',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Exchange.remote_person_label'
        db.add_column('coop_local_exchange', 'remote_person_label',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Exchange.remote_organization_label'
        db.add_column('coop_local_exchange', 'remote_organization_label',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Exchange.remote_person_uri'
        db.add_column('coop_local_exchange', 'remote_person_uri',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Exchange.remote_organization_uri'
        db.add_column('coop_local_exchange', 'remote_organization_uri',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Event.remote_person_label'
        db.add_column('coop_local_event', 'remote_person_label',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.remote_organization_label'
        db.add_column('coop_local_event', 'remote_organization_label',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.remote_person_uri'
        db.add_column('coop_local_event', 'remote_person_uri',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Event.remote_location_uri'
        db.add_column('coop_local_event', 'remote_location_uri',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Event.remote_organization_uri'
        db.add_column('coop_local_event', 'remote_organization_uri',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Event.remote_location_label'
        db.add_column('coop_local_event', 'remote_location_label',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExchangeMethod.uri'
        db.add_column('coop_local_exchangemethod', 'uri',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Engagement.remote_role_label'
        db.add_column('coop_local_engagement', 'remote_role_label',
        ...
        # Adding field 'Engagement.remote_role_uri'
        db.add_column('coop_local_engagement', 'remote_role_uri',
        ...
        # Adding field 'Tag.person_uri'
        db.add_column('coop_local_tag', 'person_uri',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Tag.concept_uri'
        db.add_column('coop_local_tag', 'concept_uri',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'ContactMedium.uri'
        db.add_column('coop_local_contactmedium', 'uri',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'dBiC4KnMEYYfVgyny2EFjh'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.calendar': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ocALxUYPcdAMd2ZAf4v3m5'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.contact': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'blank': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'vjr4oEV6HSSmHPKFMu5WCM'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.engagement': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'rgjHQnYfdgH9JgoXAVY9g3'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.event': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'VHkf2AorAfkNVuRLSyxkPL'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.exchange': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'Kcq6wbXibFxUHD9NbcG4DB'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.location': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3KLjb5m48i9KXodPRqPCmm'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.organization': {
            ...
            'transverse_themes': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['coop_local.TransverseTheme']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'kBmDuw8J3MKvHNteL9FD4K'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'442p2apN5A8r3Hhuq2DhRG'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.product': {
            ...
            'slug': ('django_extensions.db.fields.AutoSlugField', [], {'allow_duplicates': 'False', 'max_length': '50', 'separator': "u'-'", 'blank': 'True', 'populate_from': "'title'", 'overwrite': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'qqPsSK8RN4jjN43KrXeKkm'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.role': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'DPBgE9Y4pDN2kn9NruHd2C'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'vzFM5NBqSm5iHD8sMbxMK6'", 'max_length': '50', 'null': 'True'})
        },
