...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        content_type = ContentType.objects.get(app_label='coop_local', model='organization')
        group = Group.objects.get(name='Administrateur restreint')
        permission = Permission.objects.create(codename='change_only_his_organization',
                                               name='Can change only his Organization',
                                               content_type=content_type)
        group.permissions.add(permission)
        permission = Permission.objects.create(codename='delete_only_his_organization',
                                               name='Can delete only his Organization',
                                               content_type=content_type)
        group.permissions.add(permission)
        permission = Permission.objects.get(codename='change_organization')
        group.permissions.add(permission)
        Permission.objects.get(codename='change_its_organization').delete()
        Permission.objects.get(codename='delete_its_organization').delete()

    def backwards(self, orm):
        content_type = ContentType.objects.get(app_label='coop_local', model='organization')
        group = Group.objects.get(name='Administrateur restreint')
        permission = Permission.objects.create(codename='change_its_organization',
                                               name='Can change its Organization',
                                               content_type=content_type)
        permission = Permission.objects.create(codename='delete_its_organization',
                                               name='Can delete its Organization',
                                               content_type=content_type)
        Permission.objects.get(codename='change_only_his_organization').delete()
        Permission.objects.get(codename='delete_only_his_organization').delete()
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'PjYdCD42ArtTgoTjRLCLz8'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.article': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'JxzPnGtRTQVDFF2YyUc5D'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'irwEdJmHTBTYDfdaF4JEQ5'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.engagement': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'XW8VCQrr4TAZEriYGysLW6'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.exchange': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'9KtDHUg3aPcc6UbWS2dj7V'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'DVm7aqwqdHjfnXoMHSw8V3'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.navtree': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2puzeKoxKWaDGHbKfEFazW'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.offer': {
        ...
        'coop_local.organization': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'hQZw9weNif4PQ72E8Np8ri'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'BfjTKLHtF39fGZS6KWTXaS'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.product': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'VZXVCLPi3ZAATmXRyDbjBo'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.role': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'B94zNfiCUpL6oD3yamMA5o'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'hqkRcxpsrRyXMf7Yx8RUPC'", 'max_length': '50', 'null': 'True'})
        },
