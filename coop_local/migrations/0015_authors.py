...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        provider_type = orm['contenttypes.ContentType'].objects.get(app_label="coop_local", model="provider")
        for entry in LogEntry.objects.filter(action_flag=1, content_type=provider_type):
            try:
                provider = orm['coop_local.Provider'].objects.get(id=entry.object_id)
            except orm['coop_local.Provider'].DoesNotExist:
                print 'Provider %s not found' % entry.object_id
            else:
                user = orm['auth.User'].objects.get(id=entry.user_id)
                provider.authors.add(user)
                print provider.title + ' -> ' + user.username
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'jGfm3mFxD9939D3jsr59Ck'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.article': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'NP3FsTSeRmXjmfT9upe3uZ'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'nHbXo8JFHMmZGEnVU8uwgZ'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.engagement': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'EctzTn34cdEYizDXEPwgWF'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.exchange': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'m5piSjcxnG2W3w2JxGptEB'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2SExYik5MoBQb6weQStgc8'", 'max_length': '50', 'unique': 'True', 'null': 'True'}),
        ...
        'coop_local.navtree': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'CMUSVzY3mRdQEJd7SPK33Y'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.network': {
        ...
        'coop_local.organization': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'Raz9HtnP3WvcTKRRPvMnjW'", 'max_length': '50', 'unique': 'True', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'k8WHkpsixatrTJgDvc9N6R'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.product': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'MNehvfyMSUQAAEvkFFqUCR'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_local.provider': {
        ...
        'coop_local.role': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'yff7kyTxTimuDvy4dY2bY6'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'tFaEuzjKx97Nvsyv5XTfvb'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
