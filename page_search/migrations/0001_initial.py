...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageApp_Search'
        db.create_table('page_search_pageapp_search', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('page_search', ['PageApp_Search'])


    def backwards(self, orm):
        # Deleting model 'PageApp_Search'
        db.delete_table('page_search_pageapp_search')
    ...
    models = {
        ...
        'page_search.pageapp_search': {
            'Meta': {'object_name': 'PageApp_Search'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'sites.site': {
