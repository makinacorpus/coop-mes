...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin_Exchange'
        db.create_table('plugin_exchange_plugin_exchange', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('title_rule', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('plugin_exchange', ['Plugin_Exchange'])


    def backwards(self, orm):
        # Deleting model 'Plugin_Exchange'
        db.delete_table('plugin_exchange_plugin_exchange')
    ...
    models = {
        ...
        'plugin_exchange.plugin_exchange': {
            'Meta': {'object_name': 'Plugin_Exchange'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
