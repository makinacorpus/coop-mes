...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageApp_Calls'
        db.create_table('page_calls_pageapp_calls', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('page_calls', ['PageApp_Calls'])


    def backwards(self, orm):
        # Deleting model 'PageApp_Calls'
        db.delete_table('page_calls_pageapp_calls')
    ...
    models = {
        ...
        'page_calls.pageapp_calls': {
            'Meta': {'object_name': 'PageApp_Calls'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'sites.site': {
