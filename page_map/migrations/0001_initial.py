...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageApp_Map'
        db.create_table('page_map_pageapp_map', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('page_map', ['PageApp_Map'])


    def backwards(self, orm):
        # Deleting model 'PageApp_Map'
        db.delete_table('page_map_pageapp_map')
    ...
    models = {
        ...
        'file_manager.map': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['file_manager.Map']"}),
        ...
        'file_manager.filemanager': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'root': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'filemanager'", 'null': 'True', 'blank': 'True', 'to': "orm['file_manager.Map']"})
        },
        'page.page': {
        ...
        'page_map.pageapp_map': {
            'Meta': {'object_name': 'PageApp_Map'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'sites.site': {
