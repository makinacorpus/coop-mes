...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageApp_PasrAgenda'
        db.create_table('page_pasr_agenda_pageapp_pasragenda', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('page_pasr_agenda', ['PageApp_PasrAgenda'])


    def backwards(self, orm):
        # Deleting model 'PageApp_PasrAgenda'
        db.delete_table('page_pasr_agenda_pageapp_pasragenda')
    ...
    models = {
        ...
        'page_pasr_agenda.pageapp_pasragenda': {
            'Meta': {'object_name': 'PageApp_PasrAgenda'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'sites.site': {
    ...
    complete_apps = ['page_pasr_agenda']