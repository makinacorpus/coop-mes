...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin_LastNews'
        db.create_table('plugin_last_news_plugin_lastnews', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('title_rule', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('plugin_last_news', ['Plugin_LastNews'])


    def backwards(self, orm):
        # Deleting model 'Plugin_LastNews'
        db.delete_table('plugin_last_news_plugin_lastnews')
    ...
    models = {
        ...
        'plugin_last_news.plugin_lastnews': {
            'Meta': {'object_name': 'Plugin_LastNews'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
    ...
    complete_apps = ['plugin_last_news']