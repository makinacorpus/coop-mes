...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin_HomeSearch.bdis'
        db.add_column('plugin_home_search_plugin_homesearch', 'bdis',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plugin_HomeSearch.bdis'
        db.delete_column('plugin_home_search_plugin_homesearch', 'bdis')
