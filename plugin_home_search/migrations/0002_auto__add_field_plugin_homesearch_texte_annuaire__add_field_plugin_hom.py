...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin_HomeSearch.texte_annuaire'
        db.add_column('plugin_home_search_plugin_homesearch', 'texte_annuaire',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Plugin_HomeSearch.texte_carto'
        db.add_column('plugin_home_search_plugin_homesearch', 'texte_carto',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plugin_HomeSearch.texte_annuaire'
        db.delete_column('plugin_home_search_plugin_homesearch', 'texte_annuaire')

        # Deleting field 'Plugin_HomeSearch.texte_carto'
        db.delete_column('plugin_home_search_plugin_homesearch', 'texte_carto')
    ...
    models = {
        ...
        'plugin_home_search.plugin_homesearch': {
            'Meta': {'object_name': 'Plugin_HomeSearch'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'texte_annuaire': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'texte_carto': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
    ...
    complete_apps = ['plugin_home_search']