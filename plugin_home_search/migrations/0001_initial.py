...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin_HomeSearch'
        db.create_table('plugin_home_search_plugin_homesearch', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('title_rule', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('plugin_home_search', ['Plugin_HomeSearch'])


    def backwards(self, orm):
        # Deleting model 'Plugin_HomeSearch'
        db.delete_table('plugin_home_search_plugin_homesearch')
