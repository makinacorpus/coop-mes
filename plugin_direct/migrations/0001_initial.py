...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin_Direct'
        db.create_table('plugin_direct_plugin_direct', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('title_rule', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('plugin_direct', ['Plugin_Direct'])


    def backwards(self, orm):
        # Deleting model 'Plugin_Direct'
        db.delete_table('plugin_direct_plugin_direct')
