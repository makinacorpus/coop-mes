...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin_Direct.max_item'
        db.add_column('plugin_direct_plugin_direct', 'max_item',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plugin_Direct.max_item'
        db.delete_column('plugin_direct_plugin_direct', 'max_item')
    ...
    models = {
        ...
        'plugin_direct.plugin_direct': {
            'Meta': {'object_name': 'Plugin_Direct'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
